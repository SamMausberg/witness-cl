...
\title{\vspace{-1.2em}\textbf{Witness-CL: Evidence, Computation,\\and Retention in Online Learning Agents}}
\author{Samuel Mausberg}
\date{September 2026}
\hypersetup{pdftitle={Witness-CL: Evidence, Computation, and Retention in Online Learning Agents},pdfauthor={Samuel Mausberg}}
...
The stable build commands are \code{make formal} and \code{make paper}.
...
\path{paper/main.tex}. \path{docs/v10/HISTORICAL_EVIDENCE.md} maps every
early table to its saved artifact and records overlap/correction boundaries.

\paragraph{Authorship and reproducibility.}
This manuscript, code refinements and formalization used AI assistance. Human
author review and independent replication are pending. All hypothetical study
