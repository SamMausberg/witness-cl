...
.venv/bin/python tools/campaign_sequence.py \
  --out artifacts/campaign/coder-v1 \
  --runtime-receipt artifacts/campaign/runtime/server-window65536.json \
  --key-file /home/ubuntu/.local/share/witness-cl/campaign/runtime/server.key \
  --through diagnostics
```
