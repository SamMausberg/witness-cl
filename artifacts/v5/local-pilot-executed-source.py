...
def run(client, out, *, seeds=(41000,), episodes=12):
    ...
    manifest = {'status': 'running', 'native_benchmark': False,
                ...
                'invalid_output': 'count rejection and execute word 0000; no retry',
                ...
                for episode in range(episodes):
                    ...
                    for arm in order:
                        ...
                        row = {'seed': seed, 'episode': episode, 'arm': arm, 'goal': goal,
                               ...
                               'proposal_executed': candidate == chosen if proposal is not None else None,
    ...
    for arm in ARMS:
        ...
        summary[arm] = {'episodes': len(selected),
                        ...
                        'usage_missing': sum(r['model_call'] and r['usage'] is None for r in selected)}
